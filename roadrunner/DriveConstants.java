...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 8.79; // in
     ...
     * empirically tuned.
     */
    public static double kV = 0.01100;
    public static double kA = 0.0025;
    public static double kStatic = 0.07885;
    ...
    public static double MAX_ANG_VEL = Math.toRadians(415.5);
    public static double MAX_ANG_ACCEL = Math.toRadians(415.5);
