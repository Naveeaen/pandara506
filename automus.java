...
public class automus extends LinearOpMode {
    ...
    //  Set the GAIN const  ants to control the relationship between the measured position error, and how much power is
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double driveto = 0;        // Desired forward power/speed (-1 to +1)
        ...
        if (targetFound) {
            ...
            driveto  = Range.clip(rangeError * SPEED_GAIN, -MAX_AUTO_SPEED, MAX_AUTO_SPEED);
        ...
        moveRobot(drive, driveto, strafe, turn);
        sleep(10);
    ...
    public void moveRobot(SampleMecanumDrive drivee, double x, double y, double yaw) {
        SampleMecanumDrive drive = drivee;
